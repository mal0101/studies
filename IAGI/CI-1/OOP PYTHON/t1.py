...
# create buttons : 
quit_button = Button(window, text="+", pady=2)
quit_button.grid(column=1, row=2, sticky=SW, pady=20)

show_button = Button(window, text="*", pady=2)
show_button.grid(column=1, row=2, sticky=NE, pady=20)
